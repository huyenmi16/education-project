...
from .views import StudentRegistrationView, LecturerRegistrationView, LoginView, UserProfileView, ChangePasswordView, \
    UpdateProfileView, VerifyTokenView, LoginLectureView, UserDetailView
